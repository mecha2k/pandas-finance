...
if __name__ == "__main__":
    ...
    msft.loc["2014", ["Adj Close", "MA7", "MA30", "MA120"]].plot(figsize=(6, 4))
    plt.savefig("images/ch07/5104OS_07_01.png", bbox_inches="tight", dpi=300)

    # plot the price against the various rolling windows
    msft.loc["2002", ["Adj Close", "MA7", "MA30", "MA120"]].plot(figsize=(6, 4))
    plt.savefig("images/ch07/5104OS_07_02.png", bbox_inches="tight", dpi=300)
    ...
    msft_ewma["MA90"] = msft_ewma.rolling(window=span).mean()
    msft_ewma["EWMA90"] = msft_ewma["Adj Close"].ewm(span=span).mean()
    msft_ewma.loc["2014"].plot(figsize=(6, 4))
    plt.savefig("images/ch07/5104OS_07_11.png", bbox_inches="tight", dpi=300)

    ## Technical analysis techniques
    ## Cross-overs
    # plot MSFT July 2002 through Sept 2002
    # there are several simple 30 day moving average cross overs
    msft.loc["2002-1":"2002-9", ["Adj Close", "MA30"]].plot(figsize=(6, 4))
    plt.savefig("images/ch07/5104OS_07_12.png", bbox_inches="tight", dpi=300)

    # plot 30 and 90 day moving average for MSFT Jan 2002 through June 2002
    # there is one cross-over
    msft.loc["2002-1":"2002-6", ["Adj Close", "MA30", "MA90"]].plot(figsize=(6, 4))
    plt.savefig("images/ch07/5104OS_07_13.png", bbox_inches="tight", dpi=300)
    ...
    ic(result.portfolio_value)
    # what were our daily rates of return?
    ic(result.portfolio_value.pct_change())
    ...
    ic(result_for_2000[["ending_cash", "ending_value"]])

    # visualize our portfolio value
    result_for_2000.portfolio_value.plot(figsize=(6, 4))
    plt.savefig("images/ch07/5104OS_07_16.png", bbox_inches="tight", dpi=300)

    # run it over five years
    result = BuyApple().run(data["2000":"2004"]).portfolio_value
    result.plot(figsize=(6, 4))
    plt.savefig("images/ch07/5104OS_07_17.png", bbox_inches="tight", dpi=300)
    ...
    # sub_data.plot(figsize=(6,4));
    # plt.savefig('images/ch07/5104OS_07_18.png', bbox_inches='tight', dpi=300)
    #
    #
    # # In[26]:
    #
    ...
    #     plt.savefig('images/ch07/5104OS_07_19.png', bbox_inches='tight', dpi=300)
    #
    #
    # # In[29]:
    #
    ...
    #                            adjusted=True)
    # data.plot(figsize=(6,4));
    # plt.savefig('images/ch07/5104OS_07_20.png', bbox_inches='tight', dpi=300)
    #
    #
    # # In[31]:
    #
    ...
    # data['1997':].Spread.plot(figsize=(6,4))
    # plt.ylabel('Spread')
    # plt.axhline(data.Spread.mean());
    # plt.savefig('images/ch07/5104OS_07_21.png', bbox_inches='tight', dpi=300)
    #
    #
    # # In[32]:
    #
    ...
    # plt.savefig('images/ch07/5104OS_07_22.png', bbox_inches='tight', dpi=300)
